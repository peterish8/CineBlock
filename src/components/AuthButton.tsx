  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="brutal-btn p-1.5 sm:px-3 sm:py-1.5 flex items-center gap-2 bg-surface border-brutal-border hover:!border-brutal-yellow hover:!text-brutal-yellow"
      >
        <User className="w-4 h-4" strokeWidth={2.5} />
