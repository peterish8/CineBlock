...
export default function ResultsGrid({ movies, onRetry, onClose }: ResultsGridProps) {
  if (movies.length === 0) {
    return (
  ...
  return (
    <div className="flex flex-col h-full">
          ...
          <div key={movie.id} className="brutal-card p-3 flex gap-4 animate-fade-in" style={{ animationDelay: `${i * 100}ms` }}>
            ...
            <div className="flex-1 flex flex-col justify-between py-1">
              <div>
                ...
                <div className="text-brutal-muted text-xs font-mono mb-2 flex items-center gap-2">
      ...
      <div className="pt-4 border-t-2 border-brutal-border flex items-center gap-3">
